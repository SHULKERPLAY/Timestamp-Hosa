...
Дело в том, как временные метки преобразовываются на стороне клиента. Discord учитывает данные ОС о переходах с летнее на зимнее время и наоборот, 
...
Решить можно изменением пояса на +/-1 или сделать час +/-1. Учтите, что люди, живущие в часовых поясах где не было переходов на летнее время, они будут видеть корректную дату.